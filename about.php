        ...
        <main class="about-page">
            <section class="main__about about">
                <div class="about__container container">
                    ...
                    <img src="images/about-man-1.jpg" class="about__image about__image-one" alt="images/main-man.jpg">
                </div>
            </section>
            <section class="main__about about">
                <div class="about__container container">
                    <img src="images/about-man-2.jpg" class="about__image" alt="images/main-man.jpg">
                    <div class="about__block">
                        <h2 class="about__title title">О нас</h2>
                        <p class="about__text">
                            Taciti consequat auctor quis, etiam ipsum tempus, accumsan habitant
            ...
            <section class="about-contacts">
                <div class="about-contacts__container container">
                    <div class="about-contacts__image">
                        <img src="images/about-cake.jpg" alt="about-cake.jpg">
                    </div>
